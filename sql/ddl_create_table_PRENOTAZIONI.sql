CREATE TABLE "PRENOTAZIONI" 
   (	"ID_PRENOTAZIONE"  NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE INCREMENT BY 1) NOT NULL,
	...
	"POSTI_ACQUISTATI_ANDATA" VARCHAR2(100) NOT NULL, 
	"POSTI_ACQUISTATI_RITORNO" VARCHAR2(100),
